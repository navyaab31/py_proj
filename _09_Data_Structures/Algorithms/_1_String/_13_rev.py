...
I. REQUIREMENT GATHERING : reverse a string 
        ------------------------------------
...
==============
    ...
    Notes: Customer will give a string which can contain any  characters
           ...
           reverse the string
           Once he clicks on Submit button, display reversed string.
           
    Scenarios:     Empty string    Ex: ""    : "Invalid String"
                i. Single char     Ex: "H"   : "string length is more than one"
               ii. Single word     Ex: "Hello" : "display reversed string"
