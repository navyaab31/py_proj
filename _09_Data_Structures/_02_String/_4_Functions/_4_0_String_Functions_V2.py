...
print("String after capitalize2  :", str1.capitalize())  # Hello   print(10)
print("String after capitalize3  :", str1)  # hello
str2 = str1.capitalize()   # x = 10
print("String after capitalize  :", str1, str2) #  hello Hello

# 3 Ways
print("----Way 1--------")
# 1 : Current string should be used as is, new string  "one time"
str1 = 'hello'
print("String     : ", str1)
