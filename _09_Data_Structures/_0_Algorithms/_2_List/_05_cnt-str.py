...
'''REQ: count no. of strings whose length is 2'''
...
I. REQUIREMENT GATHERING : Count no. of string whose length is 2 
        ------------------------------------
...
==============
    ...
    Notes: Customer will give a list which can contain any  no. elements
            ...
            count the items whose length is equal to 2
...
3. select whose length is 2         3. check length of the each item   
