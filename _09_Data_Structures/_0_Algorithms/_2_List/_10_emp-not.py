...
'''REQ:check list is empty or not'''
...
I. REQUIREMENT GATHERING : check list if empty or not 
        ------------------------------------
...
==============
    ...
    Notes: Customer will give a list which can contain any  no. elements
            ...
            check if the items are there in the list
            display result to the user.
           
    Scenarios:     Empty list       Ex: ""    : "empty list"
    ...
    2. Technical Analysis:
    ------------------------
    Entity Name: check if the list is empty

            State   : Data types/strs:  LIST  BOOL
...
l=[]                       list1 = [1,2,3,4,5,6,7]
    
                                    BEHAVIOR:
                                    ----------
2. check if any elemets is         2. check the length of the loops
       present in the list                                         
3. if not present it's a           3. return True or False    
    empty list                                                          
